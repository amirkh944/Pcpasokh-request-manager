...
// تنظیمات SMS.ir
define('SMS_API_KEY', 'YOUR_SMS_IR_API_KEY'); // کلید API خود را اینجا قرار دهید
define('SMS_LINE_NUMBER', 'YOUR_LINE_NUMBER'); // شماره خط خود را اینجا قرار دهید

// تنظیمات عمومی پیامک
define('SMS_ENABLED', false); // برای فعال‌سازی، مقدار را true کنید
define('SMS_SIGNATURE', 'پاسخگو رایانه'); // امضای پیامک‌ها

// الگوهای پیامک (اختیاری - برای استفاده از الگوهای از پیش تعریف شده)
define('SMS_PATTERN_NEW_REQUEST', ''); // کد الگوی ثبت درخواست جدید
...
function isSMSEnabled() {
    return SMS_ENABLED && 
           ...
           SMS_LINE_NUMBER !== 'YOUR_LINE_NUMBER';
}
